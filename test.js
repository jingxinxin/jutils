...
test('difference', t => {
  let o1 = { b: 1, c: 2, d: { f: 1 }, z: 0 }
  let o2 = { c: 3, d: { f: 2 }, z: 0 }
  t.deepEqual(differenceObj(o1, o2), { b: 1, c: 2, d: { f: 1 } })
})
...
test('cleanEmpty', t => {
  let o = { a: 1, b: '', c: null, d: 0, e: NaN, f: undefined }
  cleanEmpty(o)
  t.deepEqual(o, { a: 1, d: 0 })
})
